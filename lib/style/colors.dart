...
class AppColor{
  ...
  static Color gradienstFirst=const Color(0xbf0f17ad);
  ...
  static Color homePagdeDetail=const Color(0xff7eb5fd);
  static Color lessonsBackgroundColorFirst=const Color(0xFF6588f4);
  static Color lessonsBackgroundColorSecond=const Color(0xff748ee7);
  ...
  static Color secondPageContainerGradient3ndColor= const Color(0xff7c93f6);
